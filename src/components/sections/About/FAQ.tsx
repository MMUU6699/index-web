...
const FAQS = [
  {
    title: "🤔 What is index?",
    description:
      "Just like every other website, index is also a streaming site that helps to easily access all the TV shows and movies we wanted, without spending hours searching for them.",
  },
  {
